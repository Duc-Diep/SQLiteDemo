...
public class SQLHelper extends SQLiteOpenHelper {
    static final String DB_NAME = "AccountManager";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE "+DB_TABLE_ACCOUNT+
    ...
    public void upDateAccount(int id,Account account){
        ...
        contentValues.put("username",account.getUsername());
        contentValues.put("password",account.getPassword());
        sqLiteDatabase.update(DB_TABLE_ACCOUNT,contentValues,"id=?",new String[]{id+""});
    }
    public List<Account> getAllAccount(){
        List<Account> list = new ArrayList<>();
        sqLiteDatabase = getReadableDatabase();
        Cursor cursor = sqLiteDatabase.query(DB_TABLE_ACCOUNT,null,null,null,null,null,null);
    ...
    public boolean checkExists(int id){
        sqLiteDatabase = getReadableDatabase();
        Cursor cursor = sqLiteDatabase.rawQuery("SELECT * FROM "+DB_TABLE_ACCOUNT+" WHERE id=?",new String[]{id+""});
